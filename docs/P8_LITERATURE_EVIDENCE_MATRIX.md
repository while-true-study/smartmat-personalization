...
| tan2021tser | Tan, C.W.; Bergmeir, C.; Petitjean, F.; Webb, G.I. Time series extrinsic regression. *Data Min. Knowl. Discov.* **2021**, 35, 1032–1060. doi:10.1007/s10618-021-00745-9 | journal | YES | Learning a continuous scalar from a time series (time series extrinsic regression) is a distinct task from forecasting and classification | strong | benchmark archive; no smart-mat data | §2.2 |
