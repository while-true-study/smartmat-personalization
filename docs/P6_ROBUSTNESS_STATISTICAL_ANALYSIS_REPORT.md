...
| Changes after the analysis run | reporting only: `scripts/export_p6_tables.py` now lists empty strata in Table P6-8 instead of skipping them. No analysis code, input, grid or definition changed; the tables are identical |
