...
| 2 | **Featured Application** (Applied Sciences): a short description of the application, encouraged but not mandatory | T | NEEDS APPLIED SCIENCES FINAL CHECK | optional draft in the manuscript (conservative: a potential application only, no performance claim) |
| 3 | Abstract: one paragraph of about 200 words at most; structured background–methods–results–conclusions without headings; must not contain results absent from the main text or exaggerate the conclusions | T; S | NEEDS APPLIED SCIENCES FINAL CHECK | Abstract drafted in pass 3 to about 200 words, all numbers tokenised |
...
| 7 | Author Contributions with CRediT roles; authorship limited to substantial contributors | T | MDPI-WIDE VERIFIED | [PI] |
...
| 10 | Informed Consent Statement for research involving humans ("obtained from all subjects", or a justified waiver) | T | MDPI-WIDE VERIFIED | [PI], using the documented provider statement (D-002) only as far as it goes |
