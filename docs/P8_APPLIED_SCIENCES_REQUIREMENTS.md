...
| 3 | Abstract: about 200 words maximum; single paragraph; structured without headings | I; T | VERIFIED | 204 words rendered after the dynamic-signal revision (D-060; "about 200" in the instructions); one paragraph |
