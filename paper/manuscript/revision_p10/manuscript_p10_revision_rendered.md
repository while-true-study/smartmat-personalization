<!-- Rendered by scripts/build_submission_candidate.py from paper/manuscript/manuscript_p10_revision.md (scripts/render_p10_revision.py). Do not edit; edit the source and re-render. Bracketed items are open placeholders (docs/P8_FINAL_BLOCKERS.md). -->
...
uses no pressure input, had a point-estimate error no higher than fine-tuning in 12 of 24 subject–target–budget
cells (7 with the median). No consistent within-night co-variation was found; one subject's positive night-centred
correlations after adaptation largely disappeared when centred within night and mat. In an exploratory analysis,
gradient-boosted models on 5–15-min pressure summaries beat the training mean for temperature in 2 of 3
...
3. A post-hoc comparator analysis showing that the personalization gains were mainly level corrections: a
   ...
   fine-tuning in 12 of 24 cells (7 with the adaptation-night median), the pressure-based models showed no
...
4. An exploratory scope check with median constants and with ridge and gradient-boosted models on 40-s, 5-min and
   ...
   temperature in 2 of 3 held-out subjects, on endpoints with 15 min of continuous history, through a smaller
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| User01 | temperature | 139,735 / 137 | 2.75 | 3.12 | 3.00 | 2.73 | 2.65 | 2.61 | 2.18 | 2.18 | +1.47 / 1.30 / +0.04 |
| User02 | temperature | 74,802 / 51 | 4.81 | 4.73 | 5.02 | 4.98 | 4.90 | 5.09 | 5.03 | 4.96 | −4.96 / 1.13 / −0.28 |
| User07 | temperature | 61,782 / 93 | 2.04 | 1.67 | 2.19 | 2.21 | 2.12 | 2.09 | 1.81 | 1.76 | +0.92 / 1.14 / −0.05 |
| User01 | humidity | 139,735 / 137 | 23.65 | 22.23 | 20.38 | 19.92 | 19.63 | 21.44 | 21.35 | 20.21 | +18.43 / 1.23 / +0.02 |
| User02 | humidity | 74,802 / 51 | 28.76 | 29.37 | 25.93 | 27.15 | 25.60 | 26.81 | 26.75 | 25.98 | −25.29 / 1.15 / −0.49 |
| User07 | humidity | 61,782 / 93 | 7.92 | 8.30 | 10.33 | 9.17 | 9.43 | 10.31 | 9.74 | 9.58 | +1.21 / 1.25 / +0.07 |
...
- **Temperature:** gradient boosting with 300-s or 900-s histories beat the training mean in
  2 of 3 subjects (User01 and User07; night-level intervals above zero) and not for User02, where every pressure
...
- **Level correction, matched by a constant.** Under strict evaluation, most of the error was a level offset
  ...
  point-estimate error was no higher than that of full fine-tuning in 12 of 24 cells with the mean and 7 with the
...
- **Scope of the negative result (exploratory addendum, Section 4.10).** It does not extend to every pressure model: a
  ...
  2 of 3 subjects. That advantage was a smaller level offset on the held-out subject, without within-night
...
- **Negative results reported in full:**
  ...
  - a personalized constant had a point-estimate error no higher than full fine-tuning in 12 of 24 cells (7
...
- **Statistics:** the night-level bootstrap resamples nights independently. Consecutive nights are correlated
  ...
  labels; its agreement with 23 of 24 cells is an association, not a causal test.
...
- **What the gains were:** post-hoc comparators showed that the gains were mainly level corrections.
  - The mean target of the adaptation nights, which needs no pressure input, had a point-estimate error no higher than
    full fine-tuning in 12 of 24 cells (7 with the median).
...
- **Exploratory addendum:** gradient-boosted models on 5–15-min pressure summaries beat the training mean for
  temperature in 2 of 3 cases, through smaller level offsets and without demonstrated within-night co-variation.
- **Consequence:** under the tested 40-s RAW-pressure representation, TCN architecture and fixed training and
