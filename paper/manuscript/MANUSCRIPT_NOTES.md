...
| `generated/tables/`, `generated/supplementary/`, `generated/figures/` | Tables 1–7 (Markdown, CSV, cell provenance), Tables S1–S26 and figure data, Figures 1–5 and S1–S4. Written only by the scripts below; never edited by hand |
...
```
python scripts/export_manuscript_tables.py      # Tables 1–7, S1–S26, provenance
...
**Figures and tables:**
- main: Tables 1–7 and Figures 1–5 (Tables 6–7, Figure 5 and the A, B, D columns of Table 4 are post hoc, D-058);
- supplementary: Tables S1–S26 (S20–S26 post hoc) and Figures S1–S4 (`docs/P8_TABLE_FIGURE_SELECTION.md` §4).
