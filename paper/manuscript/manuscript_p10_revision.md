...
### 4.10. Exploratory Addendum: Median Constants and Pressure-Summary Histories (Post Hoc)
...
| Subject | Target | Common endpoints (windows / nights) | Training mean | Training median | RAW-TCN 40 s | Ridge 40 s | Ridge 900 s | Boosting 40 s | Boosting 300 s | Boosting 900 s | Boosting 900 s: bias / R / r within night |
|---|---|---|---|---|---|---|---|---|---|---|---|
| User01 | temperature | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User01, target=temperature, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User01, target=temperature, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
| User02 | temperature | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User02, target=temperature, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User02, target=temperature, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
| User07 | temperature | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User07, target=temperature, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User07, target=temperature, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
| User01 | humidity | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User01, target=humidity, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User01, target=humidity, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
| User02 | humidity | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User02, target=humidity, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User02, target=humidity, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
| User07 | humidity | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=training_mean_common, history_s=, seed= | n_windows | ,d}} / {{p10_history_metrics | subject_id=User07, target=humidity, predictor=training_mean_common, history_s=, seed= | n_nights | d}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=training_mean_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=training_median_common, history_s=, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=raw_tcn, history_s=40, seed=mean | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=ridge, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=ridge, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=40, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=300, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=900, seed= | mae | .2f}} | {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=900, seed= | bias | +.2f}} / {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=900, seed= | R | .2f}} / {{p10_history_metrics | subject_id=User07, target=humidity, predictor=hgb, history_s=900, seed= | r_within | +.2f}} |
...
- **Temperature:** gradient boosting with 300-s or 900-s histories beat the training mean in
  {{COUNT:p10_history_interpretation | family=hgb, history_s=900, target=temperature, H_a_beats_training_mean_common=True}} of 3 subjects (User01 and User07; night-level intervals above zero) and not for User02, where every pressure
...
- **Level correction, matched by a constant.** Under strict evaluation, most of the error was a level offset
  ...
  A constant computed from the same adaptation labels, with no pressure input, often did nearly as well or better: its
...
- **Negative results reported in full:**
  ...
  - a personalized constant had a point-estimate error no higher than full fine-tuning in {{COUNT:p8_interpretation_cases | case_A_B_le_E=True}} of 24 cells ({{p10_point_counts | setting=rq2_primary_span, comparison=B_med MAE <= E (fine-tuning) seed-mean MAE | count | d}}
...
- **What the gains were:** post-hoc comparators showed that the gains were mainly level corrections.
  - The mean target of the adaptation nights, which needs no pressure input, had a point-estimate error no higher than
...
- **Exploratory addendum:** gradient-boosted models on 5–15-min pressure summaries beat the training mean for
