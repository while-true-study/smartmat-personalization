...
Every bracketed `[CONFIRM BEFORE SUBMISSION: …]` item of the manuscript. Fill the value in the manuscript source, re-run `python scripts/build_p15_submission.py` and `python scripts/validate_p15_submission.py`.
