# Cover letter — final draft (P16 manuscript)

> **Status: draft; not sendable until every `[CONFIRM BEFORE SUBMISSION: …]` item is resolved.**
> - Built from the P8-era draft `paper/manuscript/COVER_LETTER_DRAFT.md`, which is kept unchanged. The title and
>   the scientific summary follow the frozen P16 manuscript (`paper/manuscript/manuscript_p16_final.md`, source commit
>   62b1618). No result is added or restated beyond the manuscript.
> - No percentage of new content is claimed. Suggested or excluded reviewers go into the submission system, not into
>   this letter.
> - The sentence on author approval may be sent only after every author has approved.

---

[CONFIRM BEFORE SUBMISSION: date of submission]

Dear [CONFIRM BEFORE SUBMISSION: editor name],
...
[CONFIRM BEFORE SUBMISSION: section and Special Issue; the working candidate is the Special Issue "Future Information &
Communication Engineering 2026", section Computing and Artificial Intelligence, which collects selected papers from
ICFICE 2026].
...
- **Copyright:** [CONFIRM BEFORE SUBMISSION: conference copyright holder and reuse status of the conference paper]
...
- All authors have approved the manuscript and agree with its submission to *Applied Sciences*.
  [CONFIRM BEFORE SUBMISSION: every author has approved the submitted version]
- Prior submissions of this manuscript to MDPI journals: [CONFIRM BEFORE SUBMISSION: none, or the manuscript ID]
- Ethics and consent: [CONFIRM BEFORE SUBMISSION: Institutional Review Board approval, exemption or waiver, and
  secondary-use permission]; [CONFIRM BEFORE SUBMISSION: informed consent statement]
- Funding: [CONFIRM BEFORE SUBMISSION: funding statement]. Conflicts of interest: [CONFIRM BEFORE SUBMISSION: conflicts
  of interest, including any funder role]
- Data and code: a de-identified, model-ready dataset is prepared as a release candidate; the controller-event records
  used in the heater-context diagnostic are not included in the public release. The final release scope, repository,
  persistent identifier and licenses are stated in the Data Availability Statement once confirmed.
  [CONFIRM BEFORE SUBMISSION: final data and code release scope, and data-provider approval for the aggregate
  heater-diagnostic results and analysis code]
- The use of generative AI tools is disclosed in Materials and Methods (Section 3.8) and in the Acknowledgments.
  [CONFIRM BEFORE SUBMISSION: all authors approve this disclosure]

Sincerely,

[CONFIRM BEFORE SUBMISSION: corresponding author name, affiliation and e-mail]
